...
class denloss(caffe.Layer):
    ...
    def plot_rect(self,bb,color):
        ax=plt.gca()
        w=bb[2]-bb[0]
        h=bb[3]-bb[1]
        ax.add_patch( Rectangle( (bb[0],bb[1]), w, h, facecolor='none',edgecolor=color))
    ...
    def forward(self, bottom, top):
        ...
        savefile_root1='/home/apollo/Workspace/user/caffe/KITTI/mytest/orig'
        savefile_root2='/home/apollo/Workspace/user/caffe/KITTI/mytest/result1'
