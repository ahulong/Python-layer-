...
class TrData(caffe.Layer):
     ...
     def forward(self,bottom,top):
         #random select the image from the datasets of Yinshi
         ...
         while num<self.__class__.imgbatch:
              ...
              #reading the boudingbox of the head from the h5file
              boxs=list()
              count=0
        	 ...
        	 y2=y1+box[3]     
              ...
              for i in range(count1):
                  ...
                  curh=np.random.randint(int(0.3*h),int(0.7*h)) 
